...
public class DatagramTest extends TestCase {
    ...
    class Reflector extends Thread {
            ...
            try {
                while (alive) {
                    try {
                        ...
                        Log.d("Packet from: ",s + " (from " + packet.getAddress() + ":" + packet.getPort() + ")");
        ...
        /**
         * Creates a new Reflector object for the given local address and port.
         */
    ...
    public void testDatagram() throws Exception {
        ...
        try {
            ...
            for (int i = 1; i <= 1000; i++) {
                ...
                Log.d("Packet address: ", t + " (from " + packet.getAddress() + ":" + packet.getPort() + ")");
